%
% clear;
% addpath(genpath('C:\Users\xinyu\Documents\MATLAB_master'));
% % load('redblue.mat');
% load('c_string.mat');
% color1 = c_string{18}{5};
% 
% load('..\..\Filipo_Guido_data\25monopole_240705\Data_f2.5e1_t5_ang_8_16.mat');
...
% Dissipation = Dissipation_series(10);
% 
% Frame_select = 13;
...
select_2 = 1:6:512;
quiver(x(select_2)/pi,y(select_2)/pi,u(select_2,select_2)*0.1,v(select_2,select_2)*0.1,'off',...
    'color',color1,'LineWidth',0.25);
