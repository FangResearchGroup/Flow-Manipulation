...
% mainfolder = 'X:\Xinyu_Si_X\231201\set9';
mainfolder = 'E:\Xinyu_Si_Post_data\231201\set9';
...
imagesc(x(select_region)/ppcm,y(select_region)/ppcm,Q_s_record(select_region,select_region,100)/2/Dissipation(6));
colormap(RedBlue);
